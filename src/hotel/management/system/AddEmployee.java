...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee() {
        ...
        comboBox.setFont(new Font("Tahaoma",Font.BOLD,14));
        ...
        JLabel AED = new JLabel("ADD EMPLYEE DETAIL");
        AED.setBounds(450,24,450,35);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == add){
            ...
            if(gender == null){
                JOptionPane.showMessageDialog(null,"Pleas select Gender");
                return;
            }
           if(phone.length() != 10){
                JOptionPane.showMessageDialog(null,"Phone number must be of 10 digit ");
                return;
            }
            ...
            if(aadhar.length() != 12){
                JOptionPane.showMessageDialog(null,"Aadhar must be of 12 digits");
                return;
            }
